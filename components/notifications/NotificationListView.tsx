...
export function NotificationListView({ notifications }: Props) {
  ...
  return (
    <div className="min-h-screen bg-surface-soft text-ink pb-24">
      ...
      {/* Filter Tabs */}
      <div className="sticky top-14 z-30 bg-surface-card/90 backdrop-blur-sm px-td-md py-td-sm flex gap-td-xs overflow-x-auto no-scrollbar border-b border-divider">
        {FILTERS.map((f) => (
          <button
            key={f.key}
