 ...
 *
 * 날짜별 그룹핑 + masonry grid + 사진 추가/편집/삭제.
 * 사진 추가 모달은 PhotoAddModal로 분리.
 */

import { useState, useTransition } from "react";
import { useRouter } from "next/navigation";
import { editPhoto, removePhoto } from "@/actions/photo";
import { PhotoAddModal } from "@/components/album/PhotoAddModal";
