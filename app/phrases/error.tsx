...
export default function PhrasesError({ reset }: ErrorPageProps) {
  return (
    <div className="min-h-screen bg-surface-soft flex flex-col items-center justify-center px-td-md text-center">
      <span className="material-symbols-outlined text-6xl text-ink-mute mb-td-md">translate</span>
      <h1 className="text-xl font-bold text-ink mb-td-xs">문장 로딩 실패</h1>
