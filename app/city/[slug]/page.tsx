...
import {
  CityMedicalSection,
  CitySafetySection,
  CityPracticalSection,
  CityWeatherSection,
} from "@/components/city/CityGuideSections";
    ...
    <div className="min-h-screen bg-surface-soft text-ink pb-32">
      ...
      <main className="max-w-xl mx-auto px-td-md">
        ...
        {city.medicalFacilities && city.medicalFacilities.length > 0 && (
          <CityMedicalSection facilities={city.medicalFacilities} />
        )}

        {/* Section: Safety (F3) */}
        {city.safetyTips && (
          <CitySafetySection safetyTips={city.safetyTips} />
        )}

        {/* Section: Practical Tips (B7) */}
        {city.practicalTips && (
          <CityPracticalSection practicalTips={city.practicalTips} />
        )}
        ...
        {city.weather && (
          <CityWeatherSection weather={city.weather} />
        )}
