...
export default function EmergencyError({ reset }: ErrorPageProps) {
  return (
    <div className="min-h-screen bg-surface-soft flex flex-col items-center justify-center px-td-md text-center">
      <span className="material-symbols-outlined text-6xl text-ink-mute mb-td-md">emergency</span>
      <h1 className="text-xl font-bold text-ink mb-td-xs">응급 정보 로딩 실패</h1>
      <p className="text-td-body text-ink-soft max-w-xs leading-relaxed">
        응급 연락처 정보를 불러오지 못했어요.
      </p>
      <button
        type="button"
        onClick={reset}
