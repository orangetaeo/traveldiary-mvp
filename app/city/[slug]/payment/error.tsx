...
export default function PaymentGuideError({ reset }: ErrorPageProps) {
  return (
    <div className="min-h-screen bg-surface-soft flex flex-col items-center justify-center px-td-md text-center">
      <span className="material-symbols-outlined text-6xl text-ink-mute mb-td-md">payments</span>
      <h1 className="text-xl font-bold text-ink mb-td-xs">결제 가이드 로딩 실패</h1>
