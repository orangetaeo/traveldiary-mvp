...
| # | 모먼트 | 화면 | 담당 에이전트 | 핵심 스킬 |
|---|--------|------|--------------|----------|
| M1 | 추천 근거 패널 | 일정 상세 | T1, T3, T4 | S-02, S-03, S-05 |
| M2 | D-Day 모드 전환 | 여행 중 홈 | T7, T17 | S-04 |
| M3 | Live Replan | 재계획 모달 | T2, T5 | S-01, S-06 |
| M4 | 카메라 번역 | 번역 화면 | T6 | S-07, S-08 |
