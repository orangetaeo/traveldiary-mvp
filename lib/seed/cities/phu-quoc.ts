...
export const phuQuocCity: City = {
  ...
  practicalTips: {
    waterSafety:
      "수돗물 음용 금지. 편의점(빈마트·서클K)에서 생수 500ml 5천~1만 동. 얼음은 리조트·대형 식당은 안전, 노점은 주의.",
    toiletInfo:
      "리조트·호텔은 서양식 변기. 로컬 식당·야시장은 휴지 없는 곳 많음 — 미니 휴지 항시 휴대 권장.",
    mosquito:
      "섬 특성상 모기 많음, 특히 해질녘~밤. 빈마트에서 모기 기피제(Soffell) 구매 가능. DEET 성분 추천.",
    sunProtection:
      "열대 자외선 강렬 — SPF50+ 자외선 차단제 필수. 수상 액티비티 시 워터프루프 제품 사용.",
    haggling:
      "즈엉동 야시장·로컬 상점에서 흥정 기본. 처음 부르는 가격의 50~60%에서 시작.",
    customs: [
      "실내 입장 시 신발 탈것 (특히 현지인 가정·사원)",
  ...
  safetyTips: {
    scamWarnings: [
      "미터기 택시 우회·바가지 — 그랩 앱 이용이 가장 안전",
      "가짜 투어 에이전시 — 호텔 프론트나 Klook/KKday 등 공인 플랫폼 이용",
      "제트스키·오토바이 렌탈 후 기존 흠집 배상 요구 — 대여 전 영상 촬영 필수",
    ],
    safetyNotes: [
      "해질녘 이후 인적 드문 해변 피할 것 — 조명 없는 구간 위험",
      "귀중품은 호텔 금고에 보관, 해변에 가방 방치 금지",
      "해양 액티비티 시 구명조끼 착용 확인 — 안전 기준 느슨한 업체 있음",
    ],
    touristPolice: {
      phone: "113",
      notes:
        "113은 베트남 전국 경찰 신고 번호. 푸꾸옥은 섬이라 관광경찰 별도 배치 제한적 — 호텔 프론트에 먼저 도움 요청 권장.",
    },
    nightSafety:
      "즈엉동 시내·리조트 밀집 구역은 야간에도 비교적 안전. 오토바이 렌탈 후 무등 도로 야간 주행은 위험 — 가로등 없는 구간 많음.",
  },
